...
import { Plus, FileText, Download, Trash2, Edit, Edit2, Check, X } from 'lucide-react';
...
const ProfilePage = () => {
  ...
  const handleSaveTitle = async (resumeId) => {
    ...
    try {
      await resumeAPI.updateResume(resumeId, { title: editingTitle.trim() });
      ...
      setEditingId(null);
      setEditingTitle('');
      showSuccess('Resume title updated successfully');
    } catch (error) {
